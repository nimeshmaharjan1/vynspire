...
const formatActions: TextStyle[] = [
	...
	},
	{
		...
		element: "h1",
		level: 1,
		className: "m-0 grow !leading-none text-3xl font-extrabold",
		shortcuts: ["mod", "alt", "1"],
	},
	{
		label: "Heading 2",
		element: "h2",
		level: 2,
		className: "m-0 grow !leading-none text-xl font-bold",
		shortcuts: ["mod", "alt", "2"],
	},
	{
		label: "Heading 3",
		element: "h3",
		level: 3,
		className: "m-0 grow !leading-none text-lg font-semibold",
		shortcuts: ["mod", "alt", "3"],
	},
	{
		label: "Heading 4",
		element: "h4",
		level: 4,
		className: "m-0 grow !leading-none text-base font-semibold",
		shortcuts: ["mod", "alt", "4"],
	},
	{
		label: "Heading 5",
		element: "h5",
		level: 5,
		className: "m-0 grow !leading-none text-sm font-normal",
		shortcuts: ["mod", "alt", "5"],
	},
	{
		label: "Heading 6",
